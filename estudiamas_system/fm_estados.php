...
$consulta = "SELECT * FROM estado WHERE idestado = $idestado";
					...
					<div class="widget-content module">
						<div class="form-grid">
                        	<ul class="icons-labeled-less">
                        	  <li><a href="estados.php" title=".cross-c"><span class="icon-block-color application-view-list-c"></span>Ir a Estados</a></li></ul>
							<form method="post" name="form1" id="form1" class="topLabel" action="modificar_estado.php">
								<ul>
									<li><label class="fldTitle">Nombre del Estado<abbr title="Required Field" class="require">*</abbr>
									  <input type="hidden" value="<?php echo $idestado;?>" name="idestado" id="idestado">
									</label>
									  <div class ="fieldwrap">
										<input id="estado" name="estado" class="large textips" title="This is a textbox" type="text" maxlength="255" tabindex="1" value="<?php echo $row['estado'];?>" required/>
									</div>
									</li>
