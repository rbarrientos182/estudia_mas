...
<div id="wrapper">
	<div id="header">
		...
		<div id="usermenu">
			<a href="dashboard.php" class="admin-user"><span class="mnu-indicator"></span>Administrador<span class="user-icon"></span></a>
			<div class="sub-menu">
				<ul>
			...
			<div class="container_12">
				<div class="widget-panel grid_12">
					...
					<div class="widget-content module">
						...
						<tr>
						  <th colspan="4" align="right">
                                <span class="icon-wrap-lb-less">
                                    <a title="Icon Title" href="fa_universidades.php">
						...
						<tbody>
                        <?php 
						$consulta = "SELECT iduniversidad, nombre, estado, CASE WHEN u.estatus = 1 THEN 'Activo' ELSE 'Desactivo' END AS estatus_uni FROM universidad u, estado e WHERE u.idestado = e.idestado ORDER BY nombre";
						$resultado = $db->consulta($consulta);
						$row_universidades = $db->fetch_assoc($resultado);
						do
						{
							$tipo = NULL;
							if($row_universidades['estatus_uni']=='Activo')
							{
								$tipo = 'label l-new';
							}
							else
						...
						?>
						<tr>
                          <td><?php echo utf8_encode($row_universidades['estado']);?></td>
                          <td><?php echo utf8_encode($row_universidades['nombre']);?></td>
                          <td class="center"><span class="<?php echo $tipo; ?>"><?php echo $row_universidades['estatus_uni'];?></span></td>
                          <!-- <td class="center"><div class="user-thumb">
                                  <a href="#"><img height="40" width="40" alt="User" src="images/user-thumb1.png"></a>
                              </div></td>-->
                          <td class="center">
                          <span><a class="action-icons c-edit" href="fm_universidades.php?iduniversidad=<?php echo $row_universidades['iduniversidad']?>" title="Editar">Editar</a></span><!--<span><a class="action-icons c-delete" href="borrar_universidad.php?iduniversidad=<?php echo $row_universidades['iduniversidad'];?>" title="Borrar">Borrar</a></span>--><span><a class="action-icons c-approve" href="activar_universidad.php?iduniversidad=<?php echo $row_universidades['iduniversidad'];?>" title="Activar">Activar</a></span><span><a class="action-icons c-suspend" href="desactivar_universidad.php?iduniversidad=<?php echo $row_universidades['iduniversidad'];?>" title="Desactivar">Desactivar</a></span>
                          </td>
						</tr>
                          <?php 
						}while($row_universidades = $db->fetch_assoc($resultado));
						  ?>
						</tbody>
						<tfoot>
						<tr>
