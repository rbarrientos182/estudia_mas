					...
					<div class="widget-content module">
						<div class="form-grid">
                        	<ul class="icons-labeled-less">
                        	  <li><a href="usuarios.php" title=".cross-c"><span class="icon-block-color application-view-list-c"></span>Ir a Usuarios</a></li></ul>
							<form method="post" name="form1" id="form1" class="topLabel" action="modificar_usuario.php">
								<ul>
									<li><label class="fldTitle">Nombre<abbr title="Required Field" class="require">*</abbr>
									  ...
									  <div class ="fieldwrap">
										<input id="nombre" name="nombre" class="large textips" title="This is a textbox" type="text" maxlength="255" tabindex="1" value="<?php echo $row['nombre'];?>" required/>
									</div>
									</li>
                                    <li>
									<label class="fldTitle">Email</label>
									<div class ="fieldwrap">
										<input id="email" name="email" class="large" type="email" spellcheck="false" tabindex="4" value="<?php echo $row['email'];?>">
									</div>
									</li>
                                    <li><label class="fldTitle">Usuario<abbr title="Required Field" class="require">*</abbr></label>
									  <div class ="fieldwrap">
										<input id="user" name="user" class="large textips" title="This is a textbox" disabled="disabled"  type="text" maxlength="255" tabindex="5" value="<?php echo $row['user'];?>" required/>
									</div>
									</li>
                                    <li><label class="fldTitle">Contraseña<abbr title="Required Field" class="require">*</abbr></label>
									  <div class ="fieldwrap">
										<input id="pass" name="pass" class="large textips" title="This is a textbox" type="password" maxlength="255" tabindex="6" value="<?php echo $row['password'];?>" required/>
									</div>
									</li>
