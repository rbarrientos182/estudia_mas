					...
					<div class="widget-content module">
						<div class="form-grid">
                        	<ul class="icons-labeled-less">
                        	  <li><a href="programas.php" title=".cross-c"><span class="icon-block-color application-view-list-c"></span>Ir a Programas</a></li></ul>
							<form method="post" name="form1" id="form1" class="topLabel" action="guardar_programa.php">
								<ul>
									<li>
									  <label class="fldTitle">Programa<abbr title="Required Field" class="require">*</abbr></label>
									  <div class ="fieldwrap">
										<input id="programa" name="programa" class="large textips" title="This is a textbox" type="text" maxlength="255" tabindex="1" required/>
									</div>
									</li>
                                    <li>
									<label class="fldTitle">Descripción</label>
									<div class ="fieldwrap">
										<textarea id="descripcion" name="descripcion" class="large" spellcheck="true" rows="10" cols="50" tabindex="3"></textarea>
									</div>
									</li>
