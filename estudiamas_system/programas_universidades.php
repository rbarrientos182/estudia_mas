			...
			<div class="container_12">
				<div class="widget-panel grid_12">
					...
					<div class="widget-content module">
						...
						<tr>
						  <th colspan="4" align="right">
                                <span class="icon-wrap-lb-less">
                                    <a title="Icon Title" href="fa_programas_universidades.php">
                                        <span class="icon-block-color accept-c"></span>
                                        Agregar Programa Universidad
                                    </a>
                                </span>
                          </th>
						  </tr>
						...
						<tbody>
                        <?php 
						$consulta = "SELECT estado.estado,  universidad.nombre, COUNT(programas_has_universidad.idprogramas) AS total_programas, universidad.iduniversidad
FROM estado INNER JOIN universidad ON estado.idestado = universidad.idestado
	 LEFT JOIN programas_has_universidad ON universidad.iduniversidad = programas_has_universidad.iduniversidad
GROUP BY estado.estado,universidad.nombre, universidad.iduniversidad
ORDER BY universidad.nombre,estado.estado";
						...
						<tr>
                          ...
                          <td class="center"><?php echo $row['total_programas'];?></span></td>
                          <!-- <td class="center"><div class="user-thumb">
                                  <a href="#"><img height="40" width="40" alt="User" src="images/user-thumb1.png"></a>
                              </div></td>-->
                          <td class="center">
                         <!-- <span><a class="action-icons c-edit" href="fm_programas_universidades.php?iduniversidad=<?php echo $row['iduniversidad']?>" title="Editar">Editar</a></span>-->
                          <span><a class="action-icons c-edit" href="programas_tipos.php?iduniversidad=<?php echo $row['iduniversidad']?>" title="Editar Programas">Editar Programas</a></span>
                          </td>
						</tr>
                          <?php 
