				...
				<div class="widget-panel grid_12">
					...
					<div class="widget-content module">
						<div class="form-grid">
							...
							<form method="post" name="form1" id="form1" class="topLabel" action="guardar_usuario.php">
								<ul>
									<li><label class="fldTitle">Nombre<abbr title="Required Field" class="require">*</abbr></label>
									  <div class ="fieldwrap">
									...
									<div class ="fieldwrap">
										<input id="email" name="email" class="large" type="email" spellcheck="false" tabindex="4">
									</div>
									</li>
                                    <li><label class="fldTitle">Usuario<abbr title="Required Field" class="require">*</abbr></label>
									  <div class ="fieldwrap">
										<input id="user" name="user" class="large textips" title="This is a textbox" type="text" maxlength="255" tabindex="5" required/>
									</div>
									</li>
                                    <li><label class="fldTitle">Contraseña<abbr title="Required Field" class="require">*</abbr></label>
									  <div class ="fieldwrap">
										<input id="pass" name="pass" class="large textips" title="This is a textbox" type="password" maxlength="255" tabindex="6" required/>
									</div>
									</li>
