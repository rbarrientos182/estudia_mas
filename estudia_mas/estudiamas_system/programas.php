			...
			<div class="container_12">
				<div class="widget-panel grid_12">
					...
					<div class="widget-content module">
						...
						<tr>
						  <th colspan="4" align="right">
                                <span class="icon-wrap-lb-less">
                                    <a title="Icon Title" href="fa_programas.php">
						...
						<tbody>
                        <?php 
						$consulta = "SELECT idprogramas, programas, descripcion, CASE WHEN estatus = 1 THEN 'Activo' ELSE 'Desactivo' END AS estatus_pr FROM programas ORDER BY programas";
						$resultado = $db->consulta($consulta);
						$row_programas = $db->fetch_assoc($resultado);
						do
						{
							$tipo = NULL;
							if($row_programas['estatus_pr']=='Activo')
							{
								$tipo = 'label l-new';
							}
							else
						...
						?>
						<tr>
                          <td><?php echo utf8_encode($row_programas['programas']);?></td>
                          <td><?php echo utf8_encode($row_programas['descripcion']);?></td>
                          <td class="center"><span class="<?php echo $tipo; ?>"><?php echo $row_programas['estatus_pr'];?></span></td>
                          <!-- <td class="center"><div class="user-thumb">
                                  <a href="#"><img height="40" width="40" alt="User" src="images/user-thumb1.png"></a>
                              </div></td>-->
                          <td class="center">
                          <span><a class="action-icons c-edit" href="fm_programas.php?idprogramas=<?php echo $row_programas['idprogramas']?>" title="Editar">Editar</a></span><!--<span><a class="action-icons c-delete" href="borrar_programa.php?idprogramas=<?php echo $row_programas['idprogramas'];?>" title="Borrar">Borrar</a></span>--><span><a class="action-icons c-approve" href="activar_programa.php?idprogramas=<?php echo $row_programas['idprogramas'];?>" title="Activar">Activar</a></span><span><a class="action-icons c-suspend" href="desactivar_programa.php?idprogramas=<?php echo $row_programas['idprogramas'];?>" title="Desactivar">Desactivar</a></span>
                          </td>
						</tr>
                          <?php 
						}while($row_programas = $db->fetch_assoc($resultado));
						  ?>
						</tbody>
						<tfoot>
						<tr>
