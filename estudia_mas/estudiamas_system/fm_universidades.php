...
$consulta = "SELECT * FROM universidad WHERE iduniversidad = $iduniversidad";
				...
				<div class="widget-panel grid_12">
					...
					<div class="widget-content module">
						<div class="form-grid">
							...
							<form method="post" name="form1" id="form1" class="topLabel" action="modificar_universidad.php">
								<ul>
                                	<li>
										<label class="fldTitle">Ciudad<abbr title="Required Field" class="require">*</abbr></label>
									    <div class ="fieldwrap">
                                        <?php $consulta2 = "SELECT idestado, estado FROM estado WHERE estatus = 1 ORDER BY estado";
										...
										?>
											<select tabindex="11" id="idestado" name="idestado">
												...
												<?php
												 	do{
												 ?>
                                                		<option value="<?php echo $row2['idestado'];?>" <?php if($row['idestado']==$row2['idestado']){ echo 'selected'; }?> ><?php echo utf8_encode($row2['estado']);?></option>		
												<?php 
									...
									<li>
									  <label class="fldTitle">Universidad<abbr title="Required Field" class="require">*</abbr>
									    <input type="hidden" value="<?php echo $iduniversidad;?>" name="iduniversidad" id="idusuario">
									  </label>
									  <div class ="fieldwrap">
										<input id="nombre" name="nombre" class="large textips" title="This is a textbox" type="text" maxlength="255" tabindex="1" value="<?php echo utf8_encode($row['nombre']);?>" required/>
									  </div>
									</li>
