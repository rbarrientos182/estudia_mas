...
<div id="wrapper">
	<div id="header">
		...
		<div id="usermenu">
			<a href="dashboard.php" class="admin-user"><span class="mnu-indicator"></span>Administrator<span class="user-icon"></span></a>
			<div class="sub-menu">
				<ul>
			...
			<div class="container_12">
				<div class="widget-panel grid_12">
					...
					<div class="widget-content module">
						...
						<tr>
						  <th colspan="3" align="right">
                                <span class="icon-wrap-lb-less">
                                    <a title="Icon Title" href="fa_estados.php">
						...
						<tbody>
                        <?php 
						$consulta = "SELECT idestado, estado, estatus, CASE WHEN estatus = 1 THEN 'Activo' ELSE 'Desactivo' END AS estatus_estado FROM estado ORDER BY estado";
						$resultado = $db->consulta($consulta);
						$row_estado = $db->fetch_assoc($resultado);
						do
						{
							$tipo = NULL;
							if($row_usuarios['estatus_estado']=='Activo')
							{
								$tipo = 'label l-new';
							}
							else
						...
						?>
						<tr>
                          <td><?php echo utf8_encode($row_estado['estado']);?></td>
                          <td class="center"><?php echo $row_estado['estatus_estado'];?></td>
                          <!-- <td class="center"><div class="user-thumb">
                                  <a href="#"><img height="40" width="40" alt="User" src="images/user-thumb1.png"></a>
                              </div></td>-->
                          <td class="center">
                          <span><a class="action-icons c-edit" href="fm_estados.php?idestado=<?php echo $row_estado['idestado']?>" title="Editar">Editar</a></span><span><a class="action-icons c-delete" href="borrar_estado.php?idestado=<?php echo $row_estado['idestado'];?>" title="Borrar">Borrar</a></span><span><a class="action-icons c-approve" href="activar_estado.php?idestado=<?php echo $row_estado['idestado'];?>" title="Activar">Activar</a></span><span><a class="action-icons c-suspend" href="desactivar_estado.php?idestado=<?php echo $row_estado['idestado'];?>" title="Desactivar">Desactivar</a></span>
                          </td>
						</tr>
                          <?php 
						}while($row_estado = $db->fetch_assoc($resultado));
						  ?>
						</tbody>
						<tfoot>
						<tr>
