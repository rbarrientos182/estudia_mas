...
$consulta = "SELECT programas, descripcion FROM programas WHERE idprogramas = $idprogramas";
			...
			<div class="container_12">
				<div class="widget-panel grid_12">
					<div class="widget-top">
						<h4>Modificar Programa</h4>
					</div>
					<div class="widget-content module">
						<div class="form-grid">
                        	<ul class="icons-labeled-less">
                        	  <li><a href="usuarios.php" title=".cross-c"><span class="icon-block-color application-view-list-c"></span>Ir a Programas</a></li></ul>
							<form method="post" name="form1" id="form1" class="topLabel" action="modificar_programa.php">
								<ul>
									<li><label class="fldTitle">Nombre<abbr title="Required Field" class="require">*</abbr>
									  <input type="hidden" value="<?php echo $idprogramas;?>" name="idprogramas" id="idprogramas">
									</label>
									  <div class ="fieldwrap">
										<input id="programa" name="programa" class="large textips" title="This is a textbox" type="text" maxlength="255" tabindex="1" value="<?php echo utf8_encode($row['programas']);?>" required/>
									</div>
									</li>
                                    <li>
									<label class="fldTitle">Descripción</label>
									<div class ="fieldwrap">
										<textarea id="descripcion" name="descripcion" class="large" spellcheck="true" rows="10" cols="50" tabindex="3"><?php echo utf8_encode($row['descripcion']);?></textarea>
									</div>
									</li>
