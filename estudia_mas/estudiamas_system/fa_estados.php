				...
				<div class="widget-panel grid_12">
					...
					<div class="widget-content module">
						<div class="form-grid">
							...
							<form method="post" name="form1" id="form1" class="topLabel" action="guardar_estado.php">
								<ul>
									<li><label class="fldTitle">Nombre del Estado<abbr title="Required Field" class="require">*</abbr></label>
									  <div class ="fieldwrap">
										<input id="estado" name="estado" class="large textips" title="This is a textbox" type="text" maxlength="255" tabindex="1" required/>
									</div>
									</li>
