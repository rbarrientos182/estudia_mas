				...
				<div class="widget-panel grid_12">
					...
					<div class="widget-content module">
						<div class="form-grid">
							...
							<form method="post" name="form1" id="form1" class="topLabel" action="guardar_programa_universidad.php">
								<ul>
									<li>
									  <label class="fldTitle">Universidad<abbr title="Required Field" class="require">*</abbr></label>
									  <div class ="fieldwrap">
										<select id="iduniversidad" name="iduniversidad" tabindex="11">
                                            <?php 
												$consulta = "SELECT u.iduniversidad, u.nombre FROM universidad u WHERE NOT EXISTS (SELECT * FROM programas_has_universidad pu WHERE pu.iduniversidad = u.iduniversidad)";
									...
									<div class ="fieldwrap">
										<select data-placeholder="Elige un Programa..." class="chzn-select full" multiple name="idprogramas[]" tabindex="15">
                                        	<option value=""></option>
                                            <?php 
