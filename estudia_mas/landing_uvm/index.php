			 	...
			 	<table>
					...
					//en la parte de la consulta AND u.iduniversidad IN (id1,id2,id3,....idn) es donde van todos los ids de las universidades que correspondan a lo que se quiere filtrar en este caso son todas las de universidad UVM
			 		...
			 		$consulta = "SELECT estado.estado, estado.idestado FROM estado INNER JOIN universidad ON estado.idestado = universidad.idestado
			 					   ...
			 					   WHERE estado.estatus = 1 AND universidad.estatus = 1 AND programas_has_universidad.estatus = 1  AND tipo = 0 AND universidad.iduniversidad IN (61,62,63) GROUP BY estado.idestado, estado.estado ORDER BY estado.estado";
			 		 $consulta2 = $consulta;
