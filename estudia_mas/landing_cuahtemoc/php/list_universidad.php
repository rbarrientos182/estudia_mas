...
$consulta = "SELECT u.iduniversidad, u.nombre FROM programas_has_universidad pu, universidad u WHERE pu.iduniversidad = u.iduniversidad AND u.idestado = ".$id." AND pu.tipo = ".$tipo."  AND pu.estatus = 1 AND u.iduniversidad IN (64) GROUP BY u.iduniversidad,u.nombre ORDER BY u.nombre";
