	...
	<div class="row" style="background: url(imagenes/bg_content.png);">
		...
		<div class="tencol">
		    ...
		    <form id="registro" action="php/guardarContacto.php" class="formular" method="post" >
			 	...
			 	<table>
			 		<tr>
			 			<td colspan="3"><div class="datospersonales"> DATOS PERSONALES</div></td>
			 		</tr>
			 		<tr>
			 			<td><label><strong class="obligatorio">*</strong> Nombre(s):</label></td>
			 			<td><input name="nombre" id="nombre" type="text" size="40" maxlength="100" class="validate[required] text-input"  placeholder="Nombre(s)"/></td>
			 			<td>
			 		...
			 		<tr>
			 			...
			 			<td><input name="cp" id="cp" type="text" size="40" maxlength="5" onkeyup="validarNum('cp')" class="validate[required] text-input"  placeholder="C.P."/></td>
			 			<td>&nbsp;</td>
			 		</tr>
			 		<tr>
			 			<td><label><strong class="obligatorio">*</strong> Tel. Casa: </label></td>
			 			<td><input name="telcasa" id="telcasa" type="tel" size="40"  maxlength="10" onkeyup="validarNum('telcasa')" class="validate[required] text-input" placeholder="Tel. Casa"/>
			 				<br />
			 				<span style="font-size: 12px; float: right;">Incluir LADA</span>
			 			</td>
			 			<td>
			 				<label> Tel. trabajo: </label>
			 				<input type="tel" id="tel_trabajo" name="tel_trabajo"   placeholder="Teléfono de trabajo" onkeyup="validarNum('tel_trabajo')" maxlength="10" style="width: 70%;"/>
			 				<br />
			 				<span style="font-size: 12px; float: right;">Incluir LADA</span>
			 			</td>
			 		</tr>
			 		<tr>
			 			...
			 			<td>
			 				...
			 				<input type="tel" id="tel_cel" name="tel_cel"  placeholder="Teléfono celular" onkeyup="validarNum('tel_cel')" class="validate[required] text-input" maxlength="10" style="width: 70%;"/>
			 				<br />
			 				<span style="font-size: 12px; float: right;">Incluir LADA</span>
			 			</td>
			 		</tr>
			 		...
			 		<tr>
			 			<td colspan="3"><label> ¿Que quieres estudiar?  </label></td>
			 		</tr>
			 		<tr>
			 			<td colspan="3">
				 			<label>
			 		...
			 		?> 
			 		<tr>
			 			<td colspan="3"><label> Opción 1 </label></td>
			 		</tr>
			 		...
			 		<tr>
			 			<td colspan="3"><label> Opción 2 </label></td>
			 		</tr>
			 		<tr>
			 			<td>
			 		...
			 		<tr>
			 			<td colspan="3"><label> Opción 3 </label></td>
			 		</tr>
			 		<tr>
			 			<td colspan="3">
